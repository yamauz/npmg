...
export const DOCS: Doc[] = [
  { path: '/introduction', slug: 'introduction', mermaid: false, termDemo: false },
  {
  ...
  { path: '/basics/04-lockfiles', slug: 'basics-04-lockfiles', mermaid: true, termDemo: true },
  { path: '/history/05-npm', slug: 'history-05-npm', mermaid: true, termDemo: false },
  { path: '/history/06-yarn', slug: 'history-06-yarn', mermaid: true, termDemo: false },
  {
  ...
  { path: '/pnpm/10-advantages', slug: 'pnpm-10-advantages', mermaid: true, termDemo: true },
  { path: '/pnpm/11-workspaces', slug: 'pnpm-11-workspaces', mermaid: true, termDemo: false },
  {
  ...
  { path: '/appendix/b-glossary', slug: 'appendix-b-glossary', mermaid: false, termDemo: false },
]

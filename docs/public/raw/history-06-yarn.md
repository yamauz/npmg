...
面白いのはこのあとで、初代は客を取られてようやく重い腰を上げ、自分でも伝票を付けはじめました。**二代目が偉いのでも初代が怠慢なのでもなく、競争があったから両方の味が上がった**——この本に出てくる改良の多くはこの形をしています。ただし全部乗せの癖だけは二代目も受け継ぎました。そこに手を付けるのは三代目([7章](https://npmg.yamauz.workers.dev/history/07-pnpm-and-next-gen))です。

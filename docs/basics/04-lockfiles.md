...
[2章](/basics/02-package-json-and-semver)で見たとおり、らぁめん濃度盛汁流の品書きには「豚バラ 3 枚から 5 枚」と幅で書いてあります。要求を範囲で書いた注文書です。一方ロックファイルは、実際に仕入れをした人が残した**伝票**です。「◯◯精肉店の豚バラ、ロット XX を 4 枚」——次に仕入れに行く人がこの伝票のとおりに買えば、**誰が行っても寸分違わず同じ一杯**になります。
